let cameras = [
    ...
    },
    {
        ...
        "fx": 537.2079025172491,
        "fy": 556.8366442294383
    },
    {
        "id": 2,
        "img_name": "view_2",
        ...
        "fx": 539.9163642441556,
        "fy": 559.6440494121424
    },
    {
        "id": 3,
        "img_name": "view_3",
        ...
        "fx": 544.5460710530646,
        "fy": 564.4429225044851
    },
    {
        "id": 4,
        "img_name": "view_4",
        ...
        "fx": 585.9736907679094,
        "fy": 607.3842475325446
    },
    {
        "id": 5,
        "img_name": "view_5",
        ...
        "fx": 589.1033479759434,
        "fy": 610.6283179426338
    },
    {
        "id": 6,
        "img_name": "view_6",
        ...
        "fx": 586.0678502261705,
        "fy": 607.4819022633448
    },
    {
        "id": 7,
        "img_name": "view_7",
...
async function main() {
    ...
    const url = new URL(
        params.get("url") || "../assets/static/scene_t0.splat",
        location.href,
    );
    ...
    canvas.addEventListener("mousedown", (e) => {
        window.focus();  // ensure keyboard events reach this iframe
        carousel = false;
        e.preventDefault();
        startX = e.clientX;
        startY = e.clientY;
    ...
    const frame = (now) => {
        ...
        for (let gamepad of gamepads) {
            ...
            // Training-camera preset cycling disabled.
        ...
        if (carousel) {
            // Orbit around scene center, scaled for ~1m scene (cameras ~1 unit from origin)
            let inv = invert4(defaultViewMatrix);
            const t = Math.sin((Date.now() - start) / 5000);
            inv = translate4(inv, 0.4 * t, 0, 0.6 * (1 - Math.cos(t)));
